                ...
                <div class="card bg-light rounded-4">
                    <div class="card-body radius">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control" placeholder="name book.." required id="title">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="author" class="col-sm-2 col-form-label">Author</label>
                            <div class="col-sm-10">
                                <input type="text" name="author" class="form-control" placeholder="name Author.." required id="author">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="publication_year" class="col-sm-2 col-form-label">Publication Year</label>
                            <div class="col-sm-10">
                                <input type="number" name="publication_year" class="form-control" placeholder="2014.." required id="publication_year">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select type="number" name="id_publisher" id="id_publisher">
                                    <?php foreach ($publisher->getResultArray() as $b) { ?>
                                        <option value="<?= intval($b['id']); ?>"><?= $b['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select type="number" name="id_category" id="id_category">
                                    <?php foreach ($category->getResultArray() as $b) { ?>
                                        <option value="<?= intval($b['id']); ?>"><?= $b['category']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
